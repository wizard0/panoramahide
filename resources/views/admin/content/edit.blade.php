...
@section('content')
    ...
    <a class="btn btn-info" href="{{ route($slug . ".index") }}">{{ __('Back to List') }}</a>
    ...
    <div class="card" style="margin-top: 10px">
                ...
                @foreach($data as $row)
                    @switch($row->type)
                        ...
                        @case('string')
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="text-input" class=" form-control-label">{{ __('admin.' . $row->name) }}</label>
                                    </div>
                        ...
                        @case('text')
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="textarea-input" class=" form-control-label">{{ __('admin.' . $row->name) }}</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                        ...
                        @case('select')
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="select" class=" form-control-label">{{ __('admin.' . $row->name) }}</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                        ...
                        @case('image')
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="file-input" class=" form-control-label">{{ __('admin.' . $row->name) }}</label>
                                    </div>
                                    <div class="col-12 col-md-9">
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-success btn-sm" onclick="javascript:document.forms['edit-form'].submit()">
                <i class="fa fa-dot-circle-o"></i> {{ __('admin.save') }}
            </button>
