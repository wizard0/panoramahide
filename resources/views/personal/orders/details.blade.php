...
<hr>
<div>
    <div class="text-right" style="font-size: 18px">Итого:&nbsp;<b>{{ $orders[0]->totalPrice }}</b> руб.</div>
</div>
<div>
    <div class="w-100">
    ...
    <table class="sale_order_full_table d-flex justify-content-center text-center w-100">
        ...
        <tr>
            <td class="ps_logo">
                ...
                <img src="{{ Storage::url($orders[0]->paysystem->logo) }}" border=0 alt="" width="100"
                     height="100"/>
                <div class="paysystem_name">{{ $orders[0]->paysystem->name }}</div>
                <br>
            </td>
        </tr>
        <tr>
    ...
    <div class="w-100">
        <div class="text-right" style="margin-top: 10px">
            <a class="btn btn-danger" href="{{ route('order.cancel', $orders[0]->id) }}"
