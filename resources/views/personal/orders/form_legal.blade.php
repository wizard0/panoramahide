...
>
    ...
    <div class="form-group">
        <label>Фамилия</label>
        <input type="text" class="form-control" id="l_surname" placeholder="Фамилия"
               value="Фамилия ответственного лица" name="l_surname" required>
    </div>
    <div class="form-group">
        <label>Имя</label>
        <input type="text" class="form-control" id="l_name" placeholder="Имя" value="Имя ответственного лица"
               name="l_name" required>
    </div>
    <div class="form-group">
        <label>Отчество</label>
        <input type="text" class="form-control" id="l_patronymic" placeholder="Отчество"
               value="Отчество ответственного лица" name="l_patronymic" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label>Телефон</label>
        <input type="text" class="form-control" id="l_phone" placeholder="Телефон" value="" name="l_phone"
               data-role="js-mask-phone" required>
    </div>
    <div class="form-group">
        <label>Электронная почта</label>
        <input type="email" class="form-control" id="l_email" placeholder="Электронная почта" value=""
               name="l_email" required>
    </div>
    <div class="form-group">
        <label>Адрес доставки</label>
        <input type="text" class="form-control" id="l_delivery_address" placeholder="Адрес доставки" value=""
               name="l_delivery_address" required>
    </div>
    <div class="form-group">
        <div class="checkbox simple-checkbox">
            <input type="checkbox" id="l_personal_data_consent" value="Y" name="l_personal_data_consent"
                   checked required>
