                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 __paper">
                    ...
                    <div id="{!! str_replace('.', '-', $route_name) !!}-content" class="personal-content">
                        @if($route_name !== 'personal')
                            @yield('page-content')
                        @else
                            <p class="text-center">В личном кабинете Вы можете проверить текущее состояние корзины, ход выполнения Ваших заказов, просмотреть или изменить личную информацию, а также подписаться на новости и другие информационные рассылки.</p>
                        @endif
                    </div>
                </div>
            </div>
