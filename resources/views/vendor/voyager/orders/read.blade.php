                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @if ($row->field == 'orderList')
                                @php
                                    $cartItems = json_decode($dataTypeContent->{$row->field});
                                    $cartQty = 0;
                                    foreach($cartItems as $item)
                                        $cartQty++;
                                    $cart = (object) ['items' => $cartItems, 'totalPrice' => $dataTypeContent->totalPrice, 'totalQty' => $cartQty];
                                @endphp
                                @include('personal.cart_content', ['cart' => $cart, 'displayCheckout' => false])
                                @continue
                            @endif
                            @if($row->type == "image")
